...
exports.RandomOtpAlgorithm = void 0;
const crypto_1 = __importDefault(require("crypto"));
const getChar_1 = require("../utils/getChar");
...
class RandomOtpAlgorithm {
    ...
    constructor(options) {
        ...
        if (this.options.charset !== "custom" && this.options.customCharset) {
            throw new Error("Custom charset should only be provided when charset is 'custom'");
        }
    }
    /**
     ...
     */
    generate() {
        const chars = (0, getChar_1.getChars)(this.options.charset ?? "numeric", this.options.customCharset);
        let otp = "";
        const randomBytes = crypto_1.default.randomBytes(this.options.length || DEFAULT_LENGTH);
     ...
     * ```
     */
    verify(userOtp, expectedOtp, opts) {
        ...
        try {
            return crypto_1.default.timingSafeEqual(Buffer.from(userOtp), Buffer.from(expectedOtp));
        }
        catch {
            return false;
        }
...
exports.RandomOtpAlgorithm = RandomOtpAlgorithm;
//# sourceMappingURL=random.algorithm.js.map